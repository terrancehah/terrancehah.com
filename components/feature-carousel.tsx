      ...
      <div className="scroll-container">
        ...
        <div className="scroll-content z-80">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-white rounded-2xl h-[220px] flex align-middle p-5 mx-2 my-1 border border-gray-100 shadow-md transform transition-all hover:shadow-lg z-70">
        ...
        <div className="scroll-content">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-white rounded-2xl h-[220px] flex align-middle p-5 mx-2 my-1 border border-gray-100 shadow-md transform transition-all  hover:shadow-lg">
              <div className="flex flex-col items-center text-center space-y-3">
                  <div className="text-sky-blue bg-sky-50 p-3 rounded-full">
                    {feature.icon}
                  </div>
